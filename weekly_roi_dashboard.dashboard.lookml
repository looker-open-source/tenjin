  ...
  elements:
    ...
    - name: roi_table
      ...
      - table_calculation: roi_d1
        label: ROI% D1
        expression: "(${daily_user_metrics.revenue_d01} - ${daily_spend.total_spend})/${daily_user_metrics.revenue_d01}"
        value_format:
        value_format_name: percent_1
      - table_calculation: roi_d2
        label: ROI% D2
        expression: "(${daily_user_metrics.revenue_d02} - ${daily_spend.total_spend})/${daily_user_metrics.revenue_d02}"
        value_format:
        value_format_name: percent_1
      - table_calculation: roi_d3
        label: ROI% D3
        expression: "(${daily_user_metrics.revenue_d03} - ${daily_spend.total_spend})/${daily_user_metrics.revenue_d03}"
        value_format:
        value_format_name: percent_1
      - table_calculation: roi_d7
        label: ROI% D7
        expression: "(${daily_user_metrics.revenue_d07} - ${daily_spend.total_spend})/${daily_user_metrics.revenue_d07}"
        value_format:
        value_format_name: percent_1
      - table_calculation: roi_d14
        label: ROI% D14
        expression: "(${daily_user_metrics.revenue_d14} - ${daily_spend.total_spend})/${daily_user_metrics.revenue_d14}"
        value_format:
        value_format_name: percent_1
      - table_calculation: roi_d21
        label: ROI% D21
        expression: "(${daily_user_metrics.revenue_d21} - ${daily_spend.total_spend})/${daily_user_metrics.revenue_d21}"
        value_format:
        value_format_name: percent_1
      - table_calculation: roi_d28
        label: ROI% D28
        expression: "(${daily_user_metrics.revenue_d28} - ${daily_spend.total_spend})/${daily_user_metrics.revenue_d28}"
        value_format:
        value_format_name: percent_1
      - table_calculation: roi_d90
        label: ROI% D90
        expression: "(${daily_user_metrics.revenue_d90} - ${daily_spend.total_spend})/${daily_user_metrics.revenue_d90}"
        value_format:
        value_format_name: percent_1
      filters:
